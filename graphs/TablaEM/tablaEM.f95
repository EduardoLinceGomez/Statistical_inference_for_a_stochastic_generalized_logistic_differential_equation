...
parameter(sigma=0.01, alpha=0.40, m=2.0 ,m0=1.5, x0=0.05,delta = 10.0 / nPuntos, tol=0.002)! sigma menor a 10^-2
...
character(len=100) :: filename11 = 'EMoutputDiezX3.csv'
character(len=100) :: filename12 = 'EMestimationDiezX3.csv'
character(len=100) :: filename21 = 'EMoutputUnoX3.csv'
character(len=100) :: filename22 = 'EMestimationUnoX3.csv'
character(len=1)   :: sep = ','
