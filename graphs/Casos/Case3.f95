...
parameter(sigma=0.05, alpha=1.0, m=2.0 ,m0=1.5, x0=0.05,delta = 10.0 / nPuntos, tol=0.002)! sigma menor a 10^-2
...
character(len=100) :: filename00 = 'EstimadoresContinuoCase3.csv'
character(len=100) :: filename11 = 'EMoutputDiezXCase3.csv'
character(len=100) :: filename12 = 'EMestimationDiezXCase3.csv'
character(len=100) :: filename21 = 'EMoutputUnoXCase3.csv'
character(len=100) :: filename22 = 'EMestimationUnoXCase3.csv'
character(len=1)   :: sep = ','
