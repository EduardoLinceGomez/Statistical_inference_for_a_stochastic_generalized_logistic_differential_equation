...
parameter(sigma=0.01, alpha=0.9, m=1.0 ,m0=1.5, x0=0.05,delta = 10.0 / nPuntos, tol=0.002)! sigma menor a 10^-2
...
character(len=100) :: filename00 = 'EstimadoresContinuoCase2.csv'
character(len=100) :: filename11 = 'EMoutputDiezXCase2.csv'
character(len=100) :: filename12 = 'EMestimationDiezXCase2.csv'
character(len=100) :: filename21 = 'EMoutputUnoXCase2.csv'
character(len=100) :: filename22 = 'EMestimationUnoXCase2.csv'
character(len=1)   :: sep = ','
