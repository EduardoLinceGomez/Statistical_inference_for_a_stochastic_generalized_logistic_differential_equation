...
parameter(sigma=0.01, alpha=2.5, m=15.0 ,m0=1.5, x0=0.05,delta = 10.0 / nPuntos, tol=0.002)! sigma menor a 10^-2
...
character(len=100) :: filename00 = 'EstimadoresContinuoCase4.csv'
character(len=100) :: filename11 = 'EMoutputDiezXCase4.csv'
character(len=100) :: filename12 = 'EMestimationDiezXCase4.csv'
character(len=100) :: filename21 = 'EMoutputUnoXCase4.csv'
character(len=100) :: filename22 = 'EMestimationUnoXCase4.csv'
character(len=1)   :: sep = ','
